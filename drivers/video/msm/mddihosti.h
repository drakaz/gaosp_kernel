/* drivers/video/msm/src/drv/mddi/mddihost.h
 *
...
typedef struct GCC_PACKED {
	...
	uint32 register_data_list[4];
	/* list of up to max 16-byte register data values for/from client registers at once */

} mddi_register_multi_access_packet_type;
#endif
//UNIVERSAL_SURF
#if defined(CONFIG_SAMSUNG_CAPELA)
typedef union GCC_PACKED {
	mddi_video_stream_packet_type video_pkt;
	mddi_register_multi_access_packet_type register_pkt;
