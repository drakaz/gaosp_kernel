...
#ifdef CONFIG_SAMSUNG_TARGET //CONFIG_MACH_CAPELA_REV04
static struct mddi_esd_recovery_table lcd_esd_recovery_table[] = 
{
	{ SSITX,	{0x00010300},	1 	},
	{ START,	{0x00000001},	1 	},
	{ 1,        {0x00000000},	20	},

	{ GPIO_BLOCK_BASE,      {0x03FF0000}, 	1 },  //   # GPI .GPIODATA  # GPIO2(RESET_LCD_N) set to 0 , GPIO3(eDRAM_Power) set to 0
	{ 1,	   {0x00000000},	10   },
	{ GPIO_BLOCK_BASE,      {0x00080000}, 	1 },  //   # GPI .GPIODATA  # Release LCDD reset
	{ 1,	   {0x00000000},	10   },
	{ GPIO_BLOCK_BASE,      {0x00080008}, 	1 }, 
	{ 1,	   {0x00000000},	20   },
    ...
    { 1,        {0x00000000},   15  },  //  wait_ms(1);
    { SSITX,    {0x00010405},	1	},  //   # SPI.SSITX  
    { 1,        {0x00000000},   25  },  //  wait_ms(1);
    { SSITX,    {0x00010407},	1	},  //   # SPI.SSITX  
    { 1,        {0x00000000},   15  },  //  wait_ms(1);
    { SSITX,    {0x00010405},	1	},  //   # SPI.SSITX  
    { 1,        {0x00000000},   25  },  //  wait_ms(1);
...
static void process_mddi_lcd_recovery(struct mddi_esd_recovery_table *table, size_t count)
{
	int i;
	...
	for(i = 0; i < count; i++) 
	{
		...
		if (reg == 0)
			...
			mddi_queue_register_multi_write( reg,  (unsigned *)value, val_len, TRUE, 0);
	}
}

static void lcd_esd_recovery(void)
{
    printk("[KHG] lcd_esd_recovery \n");
 	process_mddi_lcd_recovery(lcd_esd_recovery_table, ARRAY_SIZE(lcd_esd_recovery_table));
}
#endif
...
#ifdef CONFIG_MACH_GALAXY_REV04
	if( gpio_get_value(LCD_DET))
	{
	        lcd_esd_recovery();
	}
#endif
...
static struct fb_ops msm_fb_ops = {
	...
	.fb_blank = NULL, //hg2395 deleted msm_fb_blank. it cause lcd black screen after resume,	/* blank display */
