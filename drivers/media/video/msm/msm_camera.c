...
#if 1//PGH TEMP
static int msm_camera_pict_snapshot_pending(struct msm_device_t *msm)
{
	unsigned long flags;
	int yes = 0;
...
#if 1//PGH TEMP
				msm_camera_pict_snapshot_pending(msm),
#else//ORG
	...
	unsigned long arg)
{
    ...
    case MSM_CAM_IOCTL_M4MO_I2C_READ_8BIT:                      
        return m4mo_i2c_read_8bit_from_apps((void *)arg);

    case MSM_CAM_IOCTL_M4MO_I2C_WRITE_8BIT:                   
        return m4mo_i2c_write_8bit_from_apps((void *)arg);

    case MSM_CAM_IOCTL_M4MO_I2C_WRITE_16BIT:                    
        return m4mo_i2c_write_16bit_from_apps((void *)arg);

    case MSM_CAM_IOCTL_M4MO_I2C_WRITE_32BIT:                    
        return m4mo_i2c_write_32bit_from_apps((void *)arg);

    case MSM_CAM_IOCTL_M4MO_I2C_WRITE_CATEGORY_PARAMETER:       
        return m4mo_i2c_write_category_parameter_from_apps((void *)arg);

    case MSM_CAM_IOCTL_M4MO_I2C_WRITE_MEMORY:                   
        return m4mo_i2c_write_memory_from_apps((void *)arg);

    case MSM_CAM_IOCTL_PGH_COMMAND:                             
        return pgh_command((void *)arg);

    case MSM_CAM_IOCTL_PGH_MSG:                                 
        return pgh_msg((void *)arg);
