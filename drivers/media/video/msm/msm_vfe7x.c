...
//FOR ECLAIR#define VFE_ADSP_EVENT 0x0000FFFF
...
/* Mclk_timing for M4Mo spec.
	msm_camio_camif_pad_reg_reset(void)(); */
...
static int vfe_7x_config(struct msm_vfe_cfg_cmd_t *cmd, void *data)
{
	...
	case CMD_STATS_DISABLE: {
		...
		if (vfecmd->queue == QDSP_CMDQUEUE) {
			...
			case VFE_START_CMD:
//FOR PIN OPEN TEST	msm_camio_camif_pad_reg_reset_2();
