...
#include <linux/clk.h>
#include <linux/io.h>
//#include <linux/cpufreq.h> // by Anubis
#include <mach/gpio.h>
...
//	cpufreq_set_policy(0, "performance"); // by Anubis
...
#if 0//Mclk_timing for M4Mo spec.
...
//	cpufreq_set_policy(0, "ondemand"); // by Anubis
}
