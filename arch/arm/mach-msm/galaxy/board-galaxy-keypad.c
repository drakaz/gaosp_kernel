/* linux/arch/arm/mach-msm/galaxy/board-galaxy-keypad.c
 *
 ...
 * GALAXY KEY MAP
 *
 * 090519 kt.hur	OK -> 232 : Contact Application..etc have errors opterating with ENTER KEY.
 * 090417 kt.hur	HOLD key added
 *
 */
