...
#include <linux/max9877.h>
#endif
#define LOG_AUDIO_EVENTS 1
#define LOG_AUDIO_FAULTS 0

//UNIVERSALSURF
#if defined(CONFIG_SAMSUNG_CAPELA)	// For AMP PM
int audio_enabled = 0;
#endif
...
//UNIVERSALSURF
#if defined(CONFIG_SAMSUNG_CAPELA)
		audio_enabled = 0; //UNIVERSAL_SURF
#endif
#ifdef CONFIG_MAX9877		// For AMP PM
		max9877_suspend();
#endif
...
//	printk("[TEST] audio buffer addr = 0x%x...........\n", buf);
...
//	printk("[TEST] start addr = 0x%x, rc = %d..........\n", start, rc);
	if (buf > start)
		return buf - start;
	return rc;	
}
...
static int __init audio_init(void)
{
	...
	the_audio.volume = 0x2000;		// for setting value 
