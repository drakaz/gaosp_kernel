...
#define ECS_IOCTL_APP_SET_PFLAG	_IOW(AKMIO, 0x1B, short)	/* Set raw magnetic vector flag */
#define ECS_IOCTL_APP_GET_PFLAG	_IOR(AKMIO, 0x1C, short)	/* Get raw magnetic vector flag */
